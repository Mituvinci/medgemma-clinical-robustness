...
echo ""
echo "========================================================================"
echo "  ALL 12 ANALYSIS RUNS COMPLETE — Generating Summary Table"
echo "========================================================================"
echo ""
...
echo ""
echo "Key files:"
echo "  $OUT/SUMMARY_TABLE.md    # Combined results table (for README/writeup)"
echo "  $OUT/SUMMARY_TABLE.csv   # Machine-readable summary"
echo "  ls $OUT/*.csv            # 37 CSV files"
echo "  ls $OUT/*.png            # 48 plot files"
